...
int main() {
    ...
    TreeNode* lca = findLCA(root, 20, 40);
    cout << "LCA of 20 and 40: " << (lca ? to_string(lca->data) : "None") << endl;
...
//Hướng dẫn sử dụng
//Duyệt cây: Pre-order, In-order, Post-order, Level-order.
//Cây BST: Tìm kiếm, chèn, xóa, tìm giá trị nhỏ nhất/lớn nhất.
//Tính toán đặc trưng: Chiều cao, đường kính, kiểm tra cân bằng.
//Tìm LCA: Giải bài toán tìm tổ tiên chung.